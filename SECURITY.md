...
published `0.3.3` GHCR image index
`sha256:c362fe99f1fe0ef3dfcf29f63fe29ba610e0b980b04c4691802ddf303cc58395` or the
previous qualified `0.3.2` image identified by digest
`sha256:2e9b7d5b27e344499fe233ff4e0a1fcdbbe77c8f83bd78ee0cdbc26eb7a74557`. Pin an exact
...
Security fixes target the current `0.3.3` release line and the previous `0.3.2`
